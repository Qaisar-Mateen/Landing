    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-white dark:bg-black px-4 sm:px-0">
      <div className="text-center space-y-6 max-w-2xl z-5 py-16 sm:py-0">
        ...
        <div className="space-y-3">
          <h1 className="text-4xl py-5 sm:text-7xl tracking-tight bg-clip-text bg-linear-to-r from-pink-500 via-purple-500 to-blue-500 text-transparent font-semibold leading-tight">Solutions Page</h1>
        </div>
      </div>
    </div>
  );
