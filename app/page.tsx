        ...
        <div className="space-x-3 pt-10">
          <div className="flex items-center justify-center">
            <div className="w-full max-w-xl">
              ...
              <div className="relative shadow-m rounded-full bg-zinc-100/50 dark:bg-zinc-900/50">
              <Search className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400 dark:text-zinc-400" aria-hidden="true" />
                <input id="hero-search" type="search" placeholder="Search visa types, countries or help" className="w-full pl-12 pr-4 py-3 bg-transparent rounded-lg text-sm placeholder:text-gray-400 outline-none text-zinc-900 dark:text-white" />
              </div>
            </div>
          </div>
        </div>
